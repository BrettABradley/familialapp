            ...
            <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
              ...
              <DialogContent className="[&>button:last-child]:hidden">
                <DialogHeader className="relative pb-3 border-b border-border sm:border-b-0">
                  <DialogTitle className="font-serif text-center">Create Photo Album</DialogTitle>
                  <DialogDescription className="text-center">Create a new album to organize your photos.</DialogDescription>
